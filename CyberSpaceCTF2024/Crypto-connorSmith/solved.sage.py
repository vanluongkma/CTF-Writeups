...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_ = Integer(); _sage_const_ = Integer(); _sage_const_128343650400194695855728317368374625964411188393285474608602045633884848344165541167691848864529206233808758274977093038649702499223183014076308718859474823332045322969098339686062869270453398855617114121560528507963 = Integer(128343650400194695855728317368374625964411188393285474608602045633884848344165541167691848864529206233808758274977093038649702499223183014076308718859474823332045322969098339686062869270453398855617114121560528507963); _sage_const_ = Integer(); _sage_const_ = Integer(); _sage_const_760 = Integer(760); _sage_const_2 = Integer(2); _sage_const_711 = Integer(711); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6)# from sage.rings.polynomial.multi_polynomial_sequence import PolynomialSequence
...
def defund_multivariate(f, bounds, m=_sage_const_1 , d=None):
    if not d:
        d = f.degree()
    R = f.base_ring()
    N = R.cardinality()
...
N = _sage_const_ 
e = _sage_const_ 
d = _sage_const_128343650400194695855728317368374625964411188393285474608602045633884848344165541167691848864529206233808758274977093038649702499223183014076308718859474823332045322969098339686062869270453398855617114121560528507963 
p = _sage_const_ 
q = _sage_const_ 
...
xx = p+q - sh
kk = (_sage_const_1  - e*d) // ((N+_sage_const_1 ) // _sage_const_2  - (p+q) // _sage_const_2 )
...
s = -(sh + x) // _sage_const_2 
f =  k*(A + s) - _sage_const_1 

assert f(x = xx, k=kk) == _sage_const_0 
print(f'{xx = }')
print(f'{kk = }')
start = time.time()
temp = defund_multivariate(f, bounds=(_sage_const_2 **un, _sage_const_2 **_sage_const_711 ), m=_sage_const_7 , d=_sage_const_6 )
print(temp)
