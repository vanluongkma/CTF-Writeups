	...
	while True:
		...
		if ans == 'g':
			if b == True:
				...
				pr(border, f' sp = {sp}')
				pr(border, f' sq = {sq}')
				pr(border, f' flagp = {flagp}')
				pr(border, f' flagq = {flagq}')
			else: pr(border, 'Please first send your primes! :P')
		elif ans == 's':
			pr(border, 'Send your desired prime numbers separated by comma: ')

			try:
				p = int(104387192740865169427677370388863403103475404564062548786362394754955831212243)
				q = int(66156804012073660612604613063179297816856269646695915113361739868825448200903)
